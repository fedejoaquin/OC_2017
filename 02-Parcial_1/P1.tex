...
\PEjercicio{2}Considerando los números {\textbf{decimales}} $X = 3568$ e $Y = 6432$, llevar adelante las siguientes operaciones con una precisión de cinco dígitos (incluido el signo), indicando claramente el resultado obtenido y la existencia o no de \emph{overflow}:
\begin{enumerate}[a)]
