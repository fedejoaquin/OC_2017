...
\PEjercicio{1}  Dado el número \textbf{decimal} $-393.3125$ llevar adelante los siguientes cambios de base:
\begin{enumerate}[a)]
...
\PEjercicio{2} Considerando los números {\textbf{decimales}} $X = 142$ e $Y = 113$, llevar adelante las siguientes operaciones, indicando claramente el resultado obtenido y la existencia o no de \emph{overflow}:
\begin{enumerate}[a)]
