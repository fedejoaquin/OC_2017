...
\section*{Propósito}
El objetivo principal del proyecto es implementar en lenguaje ensamblador, un programa que enumere cada una de las línea de un archivo de texto parametrizado.
